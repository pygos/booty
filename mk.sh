...
for pkg in basefiles cabundle ncurses xz make zlib file busybox flex bison gmp\
	   mpfr mpc openssl curl squashfs-tools-ng patch perl5 rhash expat \
	   libarchive jsoncpp libuv binutils gcc cmake m4 autoconf \
